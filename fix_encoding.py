...
with open('work_hours_2026_04_fixed.csv', 'w', newline='', encoding='utf-8-sig') as f:
    writer = csv.writer(f)
    writer.writerows(data)

print("Successfully saved to work_hours_2026_04_fixed.csv with utf-8-sig encoding.")
